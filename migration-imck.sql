...
DROP FUNCTION IF EXISTS imck.bh_column_exists;
DROP FUNCTION IF EXISTS imck.BUID;
DROP FUNCTION IF EXISTS imck.Constraint_exists;
...
DROP FUNCTION IF EXISTS imck.index_exists;
DROP FUNCTION IF EXISTS imck.MYSQL5_PASSWORD;
...
DROP PROCEDURE IF EXISTS imck.add_column_if_missing;
...
DROP PROCEDURE IF EXISTS imck.ComputeStockStatusForStagedInventory;
...
DROP PROCEDURE IF EXISTS imck.drop_column_if_exists;
DROP PROCEDURE IF EXISTS imck.drop_foreign_key;
DROP PROCEDURE IF EXISTS imck.drop_index_if_exists;
DROP PROCEDURE IF EXISTS imck.GetAMC;
...
DROP PROCEDURE IF EXISTS imck.StageInventoryForAMC;
...
DROP PROCEDURE IF EXISTS imck.zRecomputeStockMovementStatus;
...
DROP PROCEDURE IF EXISTS imck.zUnpostRecord;
