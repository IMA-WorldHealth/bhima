...
DROP PROCEDURE IF EXISTS imck.computeStockQuantity;
DROP PROCEDURE IF EXISTS imck.computeStockQuantityByLotUuid;
...
DROP PROCEDURE IF EXISTS imck.getCMM;
...
DROP PROCEDURE IF EXISTS imck.zComputeAllInventoryStockQuantities;
