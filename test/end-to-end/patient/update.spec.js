...
describe('Patient Edit', () => {
  ...
  it('updates a patients details', async () => {
    ...
    await components.inpuText.set('display_name', 'Updated Last Name');

    // optional information
    await components.inpuText.set('title', 'Mr.');
    await components.inpuText.set('email', 'update@email.com');
