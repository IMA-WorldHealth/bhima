...
describe('Multipayroll (indice)', () => {
  ...
  it(`should a config Staffing indice for ${conf1.display_name}`, async () => {
    ...
    await components.inpuText.set('17', 10);
    await components.inpuText.set('20', 26);
    await components.inpuText.set('21', 1);

    await components.currencyInput.set(120, 'Avance');
    await components.currencyInput.set(10, 'TAR');
    await components.currencyInput.set(4, 'Offrande');
    await components.currencyInput.set(2, 'SYND 1');
  ...
  it(`should a config Staffing indice for ${conf2.display_name}`, async () => {
    ...
    await components.inpuText.set('17', 10);
    await components.inpuText.set('20', 26);
    await components.inpuText.set('21', 3);
  ...
  it(`should set the enveloppe salarial`, async () => {
    ...
    await components.inpuText.set('pay_envelope', 3000);
