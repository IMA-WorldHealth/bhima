...
SET @expiration_date = DATE_ADD(DATE_ADD(NOW(), INTERVAL 24 MONTH), INTERVAL (100000 *RAND()) SECOND);
...
INSERT INTO `lot` (`uuid`, `label`, `initial_quantity`, `quantity`, `unit_cost`, `description`, `expiration_date`, `inventory_uuid`, `origin_uuid`, `delay`, `entry_date`, `is_assigned`) VALUES (0x3CAA76C5748041F5A55600D48B770B9D,'QUININE-C-XXX',100,100,9.4000,NULL,@expiration_date,0x6D93ED88393211EBA0B954E1AD7439C7,0x9EE84A161CF5491A9B5EC06A5BBCBC5D,0,@one_year_ago,0),
  ...
  (0x971F7AC3FF604A649773CE9539871A07,'QUININE-B-XXX',500,500,9.4000,NULL,@expiration_date,0x6D93ED88393211EBA0B954E1AD7439C7,0x9EE84A161CF5491A9B5EC06A5BBCBC5D,0,@one_year_ago,0),
  (0xA44C718A6A2D45DD9EE4BD85A9E99958,'AMP-B-ZZZ',120,120,3.1800,NULL,@expiration_date,0x6D920858393211EBA0B954E1AD7439C7,0x9EE84A161CF5491A9B5EC06A5BBCBC5D,0,@one_year_ago,0),
...
INSERT INTO `stock_movement` (`uuid`, `document_uuid`, `depot_uuid`, `lot_uuid`, `entity_uuid`, `description`, `flux_id`, `date`, `quantity`, `unit_cost`, `is_exit`, `user_id`, `reference`, `invoice_uuid`, `stock_requisition_uuid`, `period_id`) VALUES
  ...
  (0x4E6E8DA908EA4C5D82F21925ADEDD6FC,0x5D1695E2AE4C42EE80DDA6D80DE9BF07,@depot_uuid,0x8E8D1F39D57348689800EB8EA707E813,0xB1816006555845F993A0C222B5EFA6CB,'Distribution to the service Administration from Depot Principal : Consumption for June 2020',10,@six_months_ago,90,7.0600,1,1,7,NULL,NULL,GetPeriodId(@six_months_ago)),
  (0x4FD61D6DD31E406CB4F90AD76AF7FEF6,0xCC5446AF6CA44D29A955FC33AC75EAA3,@depot_uuid,0x6AA623AAA6EF4ECAB811E398D37C110D,NULL,'Initializing the inventory of the first depot.',13,@one_year_ago,60,3.1800,0,1,1,NULL,NULL,GetPeriodId(@eleven_months_ago)),
  (0x568DB860F640468EA27D5088EE2ABC64,0xCC5446AF6CA44D29A955FC33AC75EAA3,@depot_uuid,0xC26BA248149D4FAB882C97A368072F2B,NULL,'Initializing the inventory of the first depot.',13,@one_year_ago,200,9.4000,0,1,1,NULL,NULL,GetPeriodId(@eleven_months_ago)),
  (0x5D6539CF6D5A4AA4A5230669FC06BC77,0x0BF8E5AB353F4C0BA6BDD2E119C5C58E,@depot_uuid,0x8E8D1F39D57348689800EB8EA707E813,0xE3988489EF6641DF88FA8B8ED6AA03AC,'Distribution to the service Medecine Interne from Depot Principal : Consumption for April 2020',10,@eight_months_ago,60,7.0600,1,1,5,NULL,NULL,GetPeriodId(@eight_months_ago)),
  (0x5F25161D525A439885309ABAB3CE3B4E,0x5D1695E2AE4C42EE80DDA6D80DE9BF07,@depot_uuid,0xD5C6BC2825A24C218025817F8F00B8A7,0xB1816006555845F993A0C222B5EFA6CB,'Distribution to the service Administration from Depot Principal : Consumption for June 2020',10,@six_months_ago,100,9.4000,1,1,7,NULL,NULL,GetPeriodId(@six_months_ago)),
  ...
  (0xBC0BB88D64CA49F7905917C1797E692F,0x0BF8E5AB353F4C0BA6BDD2E119C5C58E,@depot_uuid,0xA44C718A6A2D45DD9EE4BD85A9E99958,0xE3988489EF6641DF88FA8B8ED6AA03AC,'Distribution to the service Medecine Interne from Depot Principal : Consumption for April 2020',10,@eight_months_ago,10,3.1800,1,1,5,NULL,NULL,GetPeriodId(@eight_months_ago)),
  (0xBD43137B5C7943A1BCDF1F3554A020E5,0x414E2B0856C840B981AB4AB7E7711D51,@depot_uuid,0x971F7AC3FF604A649773CE9539871A07,0xE3988489EF6641DF88FA8B8ED6AA03AC,'Distribution to the service Medecine Interne from Depot Principal : Distribution to a service',10,@two_months_ago,70,9.4000,1,1,10,NULL,NULL,GetPeriodId(@two_months_ago)),
  (0xC1DF96C693FD494297313D0F4763EFEA,0xCC5446AF6CA44D29A955FC33AC75EAA3,@depot_uuid,0xA44C718A6A2D45DD9EE4BD85A9E99958,NULL,'Initializing the inventory of the first depot.',13,@one_year_ago,120,3.1800,0,1,1,NULL,NULL,GetPeriodId(@eleven_months_ago)),
  ...
  (0xDCAA9887DDF24D7B8B89770B9D88EAD3,0xCC5446AF6CA44D29A955FC33AC75EAA3,@depot_uuid,0x8E8D1F39D57348689800EB8EA707E813,NULL,'Initializing the inventory of the first depot.',13,@one_year_ago,10000,7.0600,0,1,1,NULL,NULL,GetPeriodId(@eleven_months_ago)),
  (0xDEB26BF75B934CFAB67220096825145F,0x60F74D25E1B94D8DACAAD51B3318216E,@depot_uuid,0x6AA623AAA6EF4ECAB811E398D37C110D,0xE3988489EF6641DF88FA8B8ED6AA03AC,'Distribution to the service Medecine Interne from Depot Principal : Consumption of March.2020',10,@nine_months_ago,30,3.1800,1,1,4,NULL,NULL,GetPeriodId(@nine_months_ago)),
  (0xDFA64BB33B064F32A61853D7921813EF,0xCC5446AF6CA44D29A955FC33AC75EAA3,@depot_uuid,0xD5C6BC2825A24C218025817F8F00B8A7,NULL,'Initializing the inventory of the first depot.',13,@one_year_ago,200,9.4000,0,1,1,NULL,NULL,GetPeriodId(@eleven_months_ago)),
  (0xFF49CBF1A5A240E692859830840F2FC7,0xCC5446AF6CA44D29A955FC33AC75EAA3,@depot_uuid,0x6E8A11992E8641758727F73A3648A1B8,NULL,'Initializing the inventory of the first depot.',13,@one_year_ago,120,3.1800,0,1,1,NULL,NULL,GetPeriodId(@eleven_months_ago));
