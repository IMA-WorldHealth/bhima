...
-- stock lots
INSERT INTO `lot` (`uuid`, `label`, `quantity`, `unit_cost`, `expiration_date`, `inventory_uuid`, `origin_uuid`) VALUES
  (HUID('064ab1d9-5246-4402-ae8a-958fcdb07b35'), 'VITAMINE-A', 100, 1.2000, DATE_ADD(CURRENT_DATE, INTERVAL 2 YEAR), @multivitamine, HUID('e07ceadc-82cf-4ae2-958a-6f6a78c87588')),
  (HUID('5a0e06c2-6ca7-4633-8b17-92e2a59db44c'), 'VITAMINE-B', 20, 0.5000, DATE_ADD(CURRENT_DATE, INTERVAL 2 YEAR), @multivitamine, HUID('e07ceadc-82cf-4ae2-958a-6f6a78c87588')),
  (HUID('6f80748b-1d94-4247-804e-d4be99e827d2'), 'QUININE-B', 200, 0.8000, DATE_ADD(CURRENT_DATE, INTERVAL 1 MONTH),  @quinine, HUID('e07ceadc-82cf-4ae2-958a-6f6a78c87588')),
  (HUID('ae735e99-8faf-417b-aa63-9b404fca99ac'), 'QUININE-A', 100, 1.2000, '2017-04-30', @quinine, HUID('e07ceadc-82cf-4ae2-958a-6f6a78c87588')),
  (HUID('ef24cf1a-d5b9-4846-b70c-520e601c1ea6'), 'QUININE-C', 50, 2.0000, DATE_ADD(CURRENT_DATE, INTERVAL 2 YEAR), @quinine, HUID('e07ceadc-82cf-4ae2-958a-6f6a78c87588')),
...
INSERT INTO `lot` (`uuid`, `label`, `quantity`, `unit_cost`, `description`, `expiration_date`, `inventory_uuid`, `origin_uuid`, `is_assigned`) VALUES (0xACAA9876EF834D9F84E1BB7C2AF22777, 'lot 2', 1000, 1.4600, NULL, DATE_ADD(CURRENT_DATE, INTERVAL 2 YEAR), 0x43F3DECBFCE9426E940AB2150E62186C, 0x3BEA58085E864F96BC0EB48CC9181C14, 0);
INSERT INTO `lot` (`uuid`, `label`, `quantity`, `unit_cost`, `description`, `expiration_date`, `inventory_uuid`, `origin_uuid`, `is_assigned`) VALUES (0xD080D354417D47F18E8B1561E98823D9, 'PL1', 1000, 9.5100, NULL, DATE_ADD(CURRENT_DATE, INTERVAL 2 YEAR),   0x43F3DECBFCE9940A426EE62186BC2150, 0x192E85A91616498F91345965DDDE311C, 0);
INSERT INTO `lot` (`uuid`, `label`, `quantity`, `unit_cost`, `description`, `expiration_date`, `inventory_uuid`, `origin_uuid`, `is_assigned`) VALUES (0xE36AFF4F99C244A897B770E34A21E658, 'lot 1', 1000, 1.4600, NULL, DATE_ADD(CURRENT_DATE, INTERVAL 2 YEAR), 0x43F3DECBFCE9426E940AB2150E62186C, 0x3BEA58085E864F96BC0EB48CC9181C14, 0);
