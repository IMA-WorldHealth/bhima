...
INSERT INTO `lot` (`uuid`, `label`, `initial_quantity`, `quantity`, `unit_cost`, `expiration_date`, `inventory_uuid`, `origin_uuid`, `delay`, `entry_date`) VALUES
  (HUID('064ab1d9-5246-4402-ae8a-958fcdb07b35'), 'VITAMINE-A', 100, 100, 1.2000, DATE_ADD(CURRENT_DATE, INTERVAL 2 YEAR), @multivitamine, HUID('e07ceadc-82cf-4ae2-958a-6f6a78c87588'), 0, DATE_ADD(CURRENT_DATE, INTERVAL -1376 DAY)),
  (HUID('5a0e06c2-6ca7-4633-8b17-92e2a59db44c'), 'VITAMINE-B', 20, 20, 0.5000, DATE_ADD(CURRENT_DATE, INTERVAL 2 YEAR), @multivitamine, HUID('e07ceadc-82cf-4ae2-958a-6f6a78c87588'), 0, DATE_ADD(CURRENT_DATE, INTERVAL -1376 DAY)),
  (HUID('6f80748b-1d94-4247-804e-d4be99e827d2'), 'QUININE-B', 200, 200, 0.8000, DATE_ADD(CURRENT_DATE, INTERVAL 1 MONTH),  @quinine, HUID('e07ceadc-82cf-4ae2-958a-6f6a78c87588'), 0, DATE_ADD(CURRENT_DATE, INTERVAL -1376 DAY)),
  (HUID('ae735e99-8faf-417b-aa63-9b404fca99ac'), 'QUININE-A', 100, 100, 1.2000, '2017-04-30', @quinine, HUID('e07ceadc-82cf-4ae2-958a-6f6a78c87588'), 0, DATE_ADD(CURRENT_DATE, INTERVAL -1376 DAY)),
  (HUID('ef24cf1a-d5b9-4846-b70c-520e601c1ea6'), 'QUININE-C', 50, 50, 2.0000, DATE_ADD(CURRENT_DATE, INTERVAL 2 YEAR), @quinine, HUID('e07ceadc-82cf-4ae2-958a-6f6a78c87588'), 0, DATE_ADD(CURRENT_DATE, INTERVAL -1376 DAY)),
  (HUID('aca917fe-5320-4c3c-bea6-590e48cfa26b'), 'ERYTHRO-A',	10, 0,	3.1800,	DATE_ADD(CURRENT_DATE, INTERVAL 3 MONTH), @erythromycine, HUID('1908da7a-7892-48d7-a924-be647e5215ef'),	0, DATE_ADD(CURRENT_DATE, INTERVAL -66 DAY));
...
-- Insert Stock Movement status data when the building of Database
INSERT INTO `stock_movement_status` (`uuid`, `start_date`, `end_date`, `quantity`, `in_quantity`, `out_quantity`, `inventory_uuid`, `depot_uuid`) VALUES (0x4F056AB30FB411EBAD4F507B9DD6DEA5, DATE_ADD(CURRENT_DATE, INTERVAL -1376 DAY), DATE_ADD(CURRENT_DATE, INTERVAL -24 DAY), 0.0000, 10.0000, 10.0000, 0x3CF8D982EEF911EA880100155D871701, 0xD4BB1452E4FA4742A281814140246877);
INSERT INTO `stock_movement_status` (`uuid`, `start_date`, `end_date`, `quantity`, `in_quantity`, `out_quantity`, `inventory_uuid`, `depot_uuid`) VALUES (0x4F073BF10FB411EBAD4F507B9DD6DEA5, DATE_ADD(CURRENT_DATE, INTERVAL -1376 DAY), DATE_ADD(CURRENT_DATE, INTERVAL -24 DAY), 0.0000, 10.0000, 10.0000, 0x3CF8D982EEF911EA880100155D871701, 0xBD4B14524742E4FAA128246814140877);
INSERT INTO `stock_movement_status` (`uuid`, `start_date`, `end_date`, `quantity`, `in_quantity`, `out_quantity`, `inventory_uuid`, `depot_uuid`) VALUES (0x4F097E5E0FB411EBAD4F507B9DD6DEA5, DATE_ADD(CURRENT_DATE, INTERVAL -1376 DAY), DATE_ADD(CURRENT_DATE, INTERVAL -379 DAY), 350.0000, 350.0000, 0.0000, 0x43F3DECBFCE9426E940ABC2150E62186, 0xF9CAEB16168443C5A6C447DBAC1DF296);
INSERT INTO `stock_movement_status` (`uuid`, `start_date`, `end_date`, `quantity`, `in_quantity`, `out_quantity`, `inventory_uuid`, `depot_uuid`) VALUES (0x4F0AAD0B0FB411EBAD4F507B9DD6DEA5, DATE_ADD(CURRENT_DATE, INTERVAL -379 DAY), DATE_ADD(CURRENT_DATE, INTERVAL -39 DAY), 90.0000, 0.0000, 80.0000, 0x43F3DECBFCE9426E940ABC2150E62186, 0xF9CAEB16168443C5A6C447DBAC1DF296);
INSERT INTO `stock_movement_status` (`uuid`, `start_date`, `end_date`, `quantity`, `in_quantity`, `out_quantity`, `inventory_uuid`, `depot_uuid`) VALUES (0x4F0BCF130FB411EBAD4F507B9DD6DEA5, DATE_ADD(CURRENT_DATE, INTERVAL -39 DAY), DATE_ADD(CURRENT_DATE, INTERVAL -24 DAY), 85.0000, 0.0000, 5.0000, 0x43F3DECBFCE9426E940ABC2150E62186, 0xF9CAEB16168443C5A6C447DBAC1DF296);
INSERT INTO `stock_movement_status` (`uuid`, `start_date`, `end_date`, `quantity`, `in_quantity`, `out_quantity`, `inventory_uuid`, `depot_uuid`) VALUES (0x4F295CDA0FB411EBAD4F507B9DD6DEA5, DATE_ADD(CURRENT_DATE, INTERVAL -1376 DAY), DATE_ADD(CURRENT_DATE, INTERVAL -216 DAY), 45.0000, 120.0000, 75.0000, 0xF6556E729D0547998CBD0A03B1810185, 0xF9CAEB16168443C5A6C447DBAC1DF296);
