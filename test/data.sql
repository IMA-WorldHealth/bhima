...
INSERT INTO `voucher_item` VALUES
  (HUID(UUID()), 3627, 100, 0, @first_voucher, @first_invoice, HUID(UUID())),
  ...
  (HUID(UUID()), 3627, 300, 0, @third_voucher, @cash_payment, HUID(UUID())),
...
INSERT INTO `employee` VALUES
  (1,'E1','Dedrick Kitamuka Mvuezolo','M','1980-02-01 00:00:00','2016-02-02 00:00:00',HUID('71e9f21c-d9b1-11e5-8ab7-78eb2f2a46e0'),1,3,500,'TMB', '1201-3456-5423-03','kinshasa','0896611111','my@email.com',1,3,HUID('42d3756a-7770-4bb8-a899-7953cd859892'),NULL,HUID('274c51ae-efcc-4238-98c6-f402bfb39866'), 0);
