...
INSERT INTO `lot` (`uuid`, `label`, `initial_quantity`, `quantity`, `unit_cost`, `description`, `expiration_date`, `inventory_uuid`, `origin_uuid`, `delay`, `entry_date`, `is_assigned`) VALUES (0xACAA9876EF834D9F84E1BB7C2AF22777, 'lot 2', 1000, 1000, 1.4600, NULL, DATE_ADD(CURRENT_DATE, INTERVAL 2 YEAR), 0x43F3DECBFCE9426E940AB2150E62186C, 0x3BEA58085E864F96BC0EB48CC9181C14, 0, DATE_ADD(CURRENT_DATE, INTERVAL -12 WEEK), 0);
