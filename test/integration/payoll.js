...
describe('(/multiplePayroll ) the Payroll API endpoint', () => {
  ...
  const dataMultiConfiguration = {
    data : [ { employee_uuid: '75e69409-562f-a2a8-45a1-3d7938b02500',
    code: 'WWEFCB',
  ...
  const dataConfiguration = {
    data :
    {
      ...
      working_day : 20,
      value : {
        TPR : 10, PRI : 20, v_cher : 30, f_scol : 10, allc : 10,
      },
      employee : {
        uuid : '75e09694-65f2-45a1-a8a2-8b025003d793',
        code : 'E1',
        display_name : 'Test 2 Patient',
        sex : 'M',
        dob : '1990-05-31T22:00:00.000Z',
        date_embauche : '2016-02-01T23:00:00.000Z',
        service_id : 3,
        nb_spouse : 1,
        nb_enfant : 3,
        grade_uuid : '71e9f21c-d9b1-11e5-8ab7-78eb2f2a46e0',
        locked : null,
        is_medical : 0,
        text : 'grade 1',
        basic_salary : 500,
        ...
        service_txt : 'Medecine Interne',
        hospital_no : '110',
        phone : null,
        email : null,
        adresse : null,
        patient_uuid : '274c51ae-efcc-4238-98c6-f402bfb39866',
        bank : 'TMB',
        bank_account : '1201-3456-5423-03',
        individual_salary : 500,
        code_grade : 'G1',
        debtor_uuid : '3be232f9-a4b9-4af6-984c-5d3f87d5c107',
        debtor_text : 'Patient/2/Patient',
        debtor_group_uuid : '4de0fe47-177f-4d30-b95f-cff8166400b4',
        creditor_uuid : '42d3756a-7770-4bb8-a899-7953cd859892',
        creditor_text : 'Personnel',
  ...
  const dataCommitment = {
    ...
    display_name: 'EMPLOYEE TEST 1',
    sex: 'F',
    uuid: '205eb0ca-e7e6-4a27-8b8a-43a652910839',
    payroll_configuration_id: '1',
    currency_id: '2',
    paiement_date: null,
    base_taxable: 50,
