...
function CashPaymentsSearch() {
  ...
  it('GET /cash/search without parameters returns all cash payments', () => {
    return agent.get('/cash/search')
      .then((res) => {
  ...
  it('GET /cash/search?limit=1 returns a single record', () => {
    const params = { limit: 1 };
    return SendHTTPQuery(params, 1);
  });

  it('GET /cash/search?is_caution=1 returns two records', () => {
    const params = { is_caution: 1 };
    return SendHTTPQuery(params, 2);
  });

  it('GET /cash/search?debtor_uuid=? returns 3 records', () => {
    const params = { debtor_uuid: DEBTOR_UUID };
    return SendHTTPQuery(params, 3);
  });

  it('GET /cash/search?is_caution=1&limit=1 should combine to return a single record', () => {
    const params = { is_caution: 1, limit: 1 };
    return SendHTTPQuery(params, 1);
  });

  it('GET /cash/search?cashbox_id=2 should return one record', () => {
    const params = { cashbox_id: 2 };
    return SendHTTPQuery(params, 1);
  });

  it('GET /cash/search?reference=CP.TPA.1 should return a single record', () => {
    const params = { reference: 'CP.TPA.1' };
    return SendHTTPQuery(params, 1);
  });

  it('GET /cash/search?dateFrom=2016-01-01 should return all records', () => {
    const params = { dateFrom: '2016-01-01' };
    return SendHTTPQuery(params, NUM_CASH_RECORDS);
  });

  it(`GET /cash/search?dateFrom=2016-01-01&dateTo=${TOMORROW} should return all records`, () => {
    const params = { dateFrom: '2016-01-01', dateTo : TOMORROW };
    return SendHTTPQuery(params, NUM_CASH_RECORDS);
  });

  it('GET /cash/search?user_id=1 should return all records', () => {
    const params = { user_id: 1 };
    return SendHTTPQuery(params, NUM_CASH_RECORDS);
  });

  it('GET /cash/search?currency_id=1 should return all records', () => {
