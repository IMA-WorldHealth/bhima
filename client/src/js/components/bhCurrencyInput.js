...
function CurrencyInputController($scope, precision, currencyService) {
  var ctrl = this;  
  ...
  function load (){
    currencyService.detail(ctrl.currencyId)
  ...
  $scope.$watch(function (){return ctrl.currencyId;}, function (){ load(); });
...
CurrencyInputController.$inject = [ '$scope', 'precision', 'CurrencyService' ];
