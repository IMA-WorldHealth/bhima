...
CashflowReportController.$inject = [
  '$stateParams', 'CashflowService', 'NotifyService',
  'DateService', 'ExchangeRateService', 'VoucherService',
  'util',
];

/**
 * Cashflow report controller
 *
 * @description
 * This controller is responsible of cash flow report, that report include
 * all incomes minus all depenses
 */
function CashflowReportController($stateParams, Cashflow, Notify, Dates, Exchange, Voucher, util) {
