...
function DuplicateLotsController(
  ...
  //   const assignedKeys = Object.keys(duplicateLotsFilters.formatHTTP());

  //   // assign default includeEmptyLot filter
  //   if (assignedKeys.indexOf('includeEmptyLot') === -1) {
  //     duplicateLotsFilters.assignFilter('includeEmptyLot', 0);
  //     duplicateLotsFilters.formatCache();
  //     vm.latestViewFilters = duplicateLotsFilters.formatView();
  //   }
  // }

  // // on remove one filter
  // function onRemoveFilter(key) {
  //   duplicateLotsFilters.remove(key);
  //   duplicateLotsFilters.formatCache();
  //   vm.latestViewFilters = duplicateLotsFilters.formatView();
  //   return load(duplicateLotsFilters.formatHTTP(true));
  // }
  ...
  // function search() {
  //   const filtersSnapshot = duplicateLotsFilters.formatHTTP();

  //   Modal.openSearchInventories(filtersSnapshot)
  //     .then((changes) => {
  //       if (!changes) { return; }
  //       duplicateLotsFilters.replaceFilters(changes);
  //       duplicateLotsFilters.formatCache();
  //       vm.latestViewFilters = duplicateLotsFilters.formatView();
  //       load(duplicateLotsFilters.formatHTTP(true));
  //     });
  // }
  ...
  //     duplicateLotsFilters.replaceFiltersFromState($state.params.filters);
  //     duplicateLotsFilters.formatCache();
  //   }
