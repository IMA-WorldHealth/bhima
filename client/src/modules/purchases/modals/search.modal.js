...
SearchPurchaseOrderModalController.$inject = [
  ...
  'util', 'PeriodService', 'NotifyService', 'PurchaseOrderService'
];
 ...
 */
function SearchPurchaseOrderModalController(ModalInstance, params, Store, util, Periods, Notify, PurchaseOrder) {
  var vm = this;
