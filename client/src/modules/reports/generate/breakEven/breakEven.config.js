angular.module('bhima.controllers')
  .controller('breakEvenController', BreakEvenConfigController);

BreakEvenConfigController.$inject = [
  '$sce', 'NotifyService', 'BaseReportService', 'AppCache', 'reportData', '$state',
];


function BreakEvenConfigController($sce, Notify, SavedReports, AppCache, reportData, $state) {
  const vm = this;
