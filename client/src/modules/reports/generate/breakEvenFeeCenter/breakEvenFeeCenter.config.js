angular.module('bhima.controllers')
  .controller('breakEvenFeeCenterController', BreakEvenFeeCenterConfigController);

BreakEvenFeeCenterConfigController.$inject = [
  '$sce', 'NotifyService', 'BaseReportService', 'AppCache', 'reportData', '$state', 'FeeCenterService',
];


function BreakEvenFeeCenterConfigController($sce, Notify, SavedReports, AppCache, reportData, $state, FeeCenters) {
  const vm = this;
