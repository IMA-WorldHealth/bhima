angular.module('bhima.controllers')
  .controller('stock_inventory_reportController', StockInventoryReportConfigController);

StockInventoryReportConfigController.$inject = [
  '$sce', 'NotifyService', 'BaseReportService', 'AppCache', 'reportData', '$state',
  'LanguageService', 'InventoryService', '$timeout', 'moment',
];

function StockInventoryReportConfigController($sce, Notify, SavedReports, AppCache, reportData, $state,
  Languages, Inventory, $timeout, moment) {
  var vm = this;
  var cache = new AppCache('configure_stock_inventory_report');
