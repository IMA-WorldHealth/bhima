angular.module('bhima.controllers')
  .controller('monthlyConsumptionReportController', MonthlyConsumptionReportConfigController);

MonthlyConsumptionReportConfigController.$inject = [
  '$sce', 'NotifyService', 'BaseReportService', 'AppCache', 'reportData', '$state',
  'LanguageService',
];

function MonthlyConsumptionReportConfigController($sce, Notify, SavedReports, AppCache, reportData, $state, Languages) {
  const vm = this;
