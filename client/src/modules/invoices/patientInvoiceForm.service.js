...
PatientInvoiceFormService.$inject = [
  ...
  'PatientInvoiceItemService', 'bhConstants', 'ServiceService', '$q', '$translate', 'NotifyService',
];
...
Patients, PriceLists, Inventory, AppCache, Store, Pool,
  PatientInvoiceItem, Constants, Services, $q, $translate, Notify
) {
