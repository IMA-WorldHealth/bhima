...
EditAccountBudgetModalController.$inject = [
  ...
  'SessionService',
  'NotifyService', '$state', '$rootScope', 'data', '$translate',
];

function EditAccountBudgetModalController(Budget, Currency, Instance, Accounts, Session, Notify, $state, $rootScope, data, $translate) {
  const vm = this;
