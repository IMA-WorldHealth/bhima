...
AllocationBasisEditController.$inject = [
  'FeeCenterService', 'AllocationBasisService', 'ModalService', 'NotifyService',
  '$uibModalInstance', 'uiGridConstants', '$translate',
];

function AllocationBasisEditController(FeeCenter, AllocationBasisService, Modal, Notify, Instance,
  ...
  function editAllocationBasis(id) {
    FeeCenter.createUpdateAllocationBasis({ id })
      .result
      .then(() => {
        loadAllocationBases();
      });
  ...
  function createAllocationBasis() {
    FeeCenter.createUpdateAllocationBasis({})
      .result
      .then(() => {
        loadAllocationBases();
      });
  ...
  const columns = [{
    ...
    headerCellFilter : 'translate',
    cellTemplate : '/modules/fee_center/templates/description.cell.html',
  }, {
    field : 'units',
    ...
    cellTemplate : '/modules/fee_center/templates/predefined.cell.html',
    width : 110,
  }, {
    field : 'actions',
    ...
    displayName : '',
    headerCellFilter : 'translate',
    cellTemplate : '/modules/fee_center/templates/action_edit_allocation_basis.tmpl.html',
  }];
