angular.module('bhima.controllers')
  .controller('fee_centerController', fee_centerController);

fee_centerController.$inject = [
 ...
 */
function fee_centerController(FeeCenters, ModalService, Notify, uiGridConstants) {
  const vm = this;
