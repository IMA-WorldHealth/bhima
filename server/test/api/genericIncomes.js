...
describe('The /cash/generic/incomes API endpoint :: ', function () {
  ...
  /** random future date (10 days after in our case) which doesn't have an exchange rate defined */
  var futurDate = new Date(date.getYear() + 1900, date.getMonth(), date.getDate() + 10);
