...
DROP TRIGGER cash_before_insert;
DROP TRIGGER cash_document_map;
DROP TRIGGER employee_before_insert;
DROP TRIGGER employee_entity_map;
DROP TRIGGER invoice_reference;
DROP TRIGGER invoice_document_map;
DROP TRIGGER patient_reference;
DROP TRIGGER patient_entity_map;
DROP TRIGGER purchase_reference;
DROP TRIGGER purchase_document_map;
DROP TRIGGER supplier_before_insert;
DROP TRIGGER supplier_entity_map;
DROP TRIGGER voucher_before_insert;
DROP TRIGGER voucher_document_map;

DROP PROCEDURE IF EXISTS imck.AddMissingMovementReference;
...
DROP PROCEDURE IF EXISTS imck.ComputeMovementReference;
...
DROP PROCEDURE IF EXISTS imck.stockInventoryReport;
