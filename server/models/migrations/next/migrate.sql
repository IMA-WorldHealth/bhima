...
ALTER TABLE `posting_journal` ADD COLUMN `principal_center_id` MEDIUMINT(8) UNSIGNED NULL;
...
ALTER TABLE `general_ledger` ADD COLUMN `cost_center_id`      MEDIUMINT(8) UNSIGNED NULL;
ALTER TABLE `general_ledger` ADD COLUMN `principal_center_id` MEDIUMINT(8) UNSIGNED NULL;
