...
CREATE TABLE `stock_setting` (
  ...
  `average_consumption_algo` VARCHAR(100) NOT NULL DEFAULT 'algo3', -- The average consumption is obtained by dividing the quantity consumed during the period defined by the number of days in the period, and by multiplying the result obtained by 30.5
