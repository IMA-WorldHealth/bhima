...
INSERT INTO unit VALUES
  ...
  (218,'Fee Center Management','TREE.FEE_CENTER_MANAGEMENT','',0,'/cost_center'),
  (219,'Fee Center Management','TREE.FEE_CENTER','',218,'/cost_center'),
  ...
  (222,'Fee Center Report','TREE.FEE_CENTER_REPORT','Fee Center Report',286,'/reports/cost_center'),
  (223,'Distribution keys','TREE.DISTRIBUTION_KEYS','Distribution keys',218,'/distribution_center/allocation_key'),
  ...
  (232,'Break Even By Fee Center','TREE.BREAK_EVEN_FEE_CENTER_REPORT','Break-even By Fee Center Report',286,'/reports/break_even_cost_center'),
...
INSERT INTO `report` (`report_key`, `title_key`) VALUES
  ...
  ('cost_center', 'REPORT.FEE_CENTER.TITLE'),
  ('break_even', 'TREE.BREAK_EVEN_REPORT'),
  ('break_even_cost_center', 'TREE.BREAK_EVEN_FEE_CENTER_REPORT'),
