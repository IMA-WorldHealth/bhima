...
INSERT INTO `location_type` (`translation_key`, `color`, `fixed`, `is_leaves`) VALUES
  ('LOCATION.LOCATION_TYPE.BOROUGH', '#9ACD32', 1, 0),
  ('LOCATION.LOCATION_TYPE.CHIEFDOM', '#DC143C', 1, 0),
  ('LOCATION.LOCATION_TYPE.COMMUNITY', '#228B22', 1, 0),
  ('LOCATION.LOCATION_TYPE.COUNTRY', '#007FFF', 1, 0),
  ('LOCATION.LOCATION_TYPE.CITY', '#FF4500', 1, 0),
  ('LOCATION.LOCATION_TYPE.DEPARTMENT', '#6A5ACD', 1, 0),
  ('LOCATION.LOCATION_TYPE.DISTRICT', '#EE82EE', 1, 0),
  ('LOCATION.LOCATION_TYPE.GROUP', '#00FF00', 1, 0),
  ('LOCATION.LOCATION_TYPE.PROVINCE', '#F72618', 1, 0),
  ('LOCATION.LOCATION_TYPE.REGION', '#7FFF00', 1, 0),
  ('LOCATION.LOCATION_TYPE.SECTOR', '#40E0D0', 1, 0),
  ('LOCATION.LOCATION_TYPE.STATE', '#CE1021', 1, 0),
  ('LOCATION.LOCATION_TYPE.STREET', '#2E8B57', 1, 0),
  ('LOCATION.LOCATION_TYPE.TERRITORY', '#ED7E15', 1, 0),
  ('LOCATION.LOCATION_TYPE.TOWN', '#FF7F50', 1, 0),
  ('LOCATION.LOCATION_TYPE.TOWNSHIP', '#4169E1', 1, 0),
  ('LOCATION.LOCATION_TYPE.VILLAGE', '#EEFA05', 1, 0),
  ('LOCATION.LOCATION_TYPE.ZONE', '#8A2BE2', 1, 0);
