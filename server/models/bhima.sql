...
INSERT INTO `location_type` (`translation_key`, `color`, `fixed`, `is_leaves`) VALUES
  ...
  ('LOCATION.LOCATION_TYPE.SECTOR', '#FF7F50', 1, 0),
  ('LOCATION.LOCATION_TYPE.STATE', '#EE82EE', 1, 0),
  ('LOCATION.LOCATION_TYPE.STREET', '#2E8B57', 1, 0),
  ('LOCATION.LOCATION_TYPE.TERRITORY', '#ED7E15', 1, 0),
  ('LOCATION.LOCATION_TYPE.TOWN', '#CE1021', 1, 0),
  ('LOCATION.LOCATION_TYPE.TOWNSHIP', '#4169E1', 1, 0),
  ('LOCATION.LOCATION_TYPE.VILLAGE', '#FF4500', 1, 0),
  ('LOCATION.LOCATION_TYPE.ZONE', '#40E0D0', 1, 0);
