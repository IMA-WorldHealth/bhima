...
INSERT INTO `cost_center_allocation_basis`
  (`id`, `name`, `units`, `description`, `is_predefined`, `is_currency`, `decimal_places`, is_editable)
  VALUES
  (1, 'ALLOCATION_BASIS_DIRECT_COST', '',
      'ALLOCATION_BASIS_DIRECT_COST_DESCRIPTION', 1, 1, 2, 1),
  (2, 'ALLOCATION_BASIS_NUM_EMPLOYEES', '',
      'ALLOCATION_BASIS_NUM_EMPLOYEES_DESCRIPTION', 1, 0, 0, 0),
  (3, 'ALLOCATION_BASIS_AREA_USED', 'ALLOCATION_BASIS_AREA_USED_UNITS',
      'ALLOCATION_BASIS_AREA_USED_DESCRIPTION', 1, 0, 1, 1),
  (4, 'ALLOCATION_BASIS_ELECTRICITY_CONSUMED', 'ALLOCATION_BASIS_ELECTRICITY_CONSUMED_UNITS',
      'ALLOCATION_BASIS_ELECTRICITY_CONSUMED_DESCRIPTION', 1, 0, 1, 1),
  (5, 'ALLOCATION_BASIS_NUM_COMPUTERS', '',
      'ALLOCATION_BASIS_NUM_COMPUTERS_DESCRIPTION', 1, 0, 0, 1),
  (6, 'ALLOCATION_BASIS_NUM_LABOR_HOURS', 'ALLOCATION_BASIS_NUM_LABOR_HOURS_UNITS',
      'ALLOCATION_BASIS_NUM_LABOR_HOURS_DESCRIPTION', 1, 0, 1, 1);
