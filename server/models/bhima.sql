...
INSERT INTO `location_type` (`translation_key`, `label_name`, `color`, `fixed`, `is_leaves`) VALUES
  ('LOCATION.LOCATION_TYPE.BOROUGH', 'borough', '#9ACD32', 1, 0),
  ('LOCATION.LOCATION_TYPE.CHIEFDOM', 'chiefdom', '#DC143C', 1, 0),
  ('LOCATION.LOCATION_TYPE.COMMUNITY', 'community', '#228B22', 1, 0),
  ('LOCATION.LOCATION_TYPE.COUNTRY', 'country', '#007FFF', 1, 0),
  ('LOCATION.LOCATION_TYPE.CITY', 'city', '#FF4500', 1, 0),
  ('LOCATION.LOCATION_TYPE.DEPARTMENT', 'department', '#6A5ACD', 1, 0),
  ('LOCATION.LOCATION_TYPE.DISTRICT', 'district', '#EE82EE', 1, 0),
  ('LOCATION.LOCATION_TYPE.GROUP', 'group', '#00FF00', 1, 0),
  ('LOCATION.LOCATION_TYPE.PROVINCE', 'province', '#F72618', 1, 0),
  ('LOCATION.LOCATION_TYPE.REGION', 'region', '#7FFF00', 1, 0),
  ('LOCATION.LOCATION_TYPE.SECTOR', 'sector', '#40E0D0', 1, 0),
  ('LOCATION.LOCATION_TYPE.STATE', 'state', '#CE1021', 1, 0),
  ('LOCATION.LOCATION_TYPE.STREET', 'street', '#2E8B57', 1, 0),
  ('LOCATION.LOCATION_TYPE.TERRITORY', 'territory', '#ED7E15', 1, 0),
  ('LOCATION.LOCATION_TYPE.TOWN', 'town', '#FF7F50', 1, 0),
  ('LOCATION.LOCATION_TYPE.TOWNSHIP', 'township', '#4169E1', 1, 0),
  ('LOCATION.LOCATION_TYPE.VILLAGE', 'village', '#EEFA05', 1, 0),
  ('LOCATION.LOCATION_TYPE.ZONE', 'zone', '#8A2BE2', 1, 0);
