...
INSERT INTO `location_type` (`translation_key`, `color`, `fixed`, `is_leaves`) VALUES
  ...
  ('LOCATION.LOCATION_TYPE.SECTOR', '#FF4500', 1, 0),
  ('LOCATION.LOCATION_TYPE.STATE', '#EEFA05', 1, 0),
  ...
  ('LOCATION.LOCATION_TYPE.VILLAGE', '#CE1021', 1, 0),
