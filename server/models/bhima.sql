...
INSERT INTO unit VALUES
  ...
  (144, 'Reports (Finance)', 'TREE.REPORTS', 'A folder holding all finance reports', 0, '/finance/REPORT_FOLDER'),
  (145, 'Cashflow', 'TREE.CASHFLOW', 'The Cashflow Report', 144, '/reports/cashflow'),
  ...
  (149, 'Cash Report', 'TREE.CASH_REPORT', 'The report of cash entry and exit', 144, '/reports/cash_report'),
  (150, 'Balance Report', 'TREE.BALANCE_REPORT', 'Balance report module', 144, '/reports/balance_report'),
  (151, 'Customer Debts', 'TREE.AGED_DEBTORS', 'Aged Debtors', 144, '/reports/aged_debtors'),
  (152, 'Account report', 'TREE.REPORT_ACCOUNTS', 'The report accounts', 144, '/reports/account_report'),
  (153, 'Report Cashflow by Service', 'TREE.CASHFLOW_BY_SERVICE', 'CashflowByService', 144, '/reports/cashflowByService'),
  ...
  (157, 'Open Debtors', 'REPORT.OPEN_DEBTORS.TREE', 'Open Debtors', 144, '/reports/open_debtors'),
  ...
  (168, 'Aged Creditors', 'TREE.AGED_CREDITORS', 'Aged Creditors', 144, '/reports/aged_creditors'),
  (170, 'Account Statement', 'TREE.ACCOUNT_STATEMENT', 'Account Statement Module', 5, '/account_statement'),
  (180, 'Income Expenses', 'REPORT.PROFIT_AND_LOSS', 'The report of income and expenses', 144, '/reports/income_expense'),
  (181, 'Stock Report', 'TREE.STOCK_REPORT', 'The report of inventories in stock', 144, '/reports/inventory_report'),
  (182, 'Stock Sheet Report', 'TREE.STOCK_INVENTORY_REPORT', 'The report of an inventory in stock', 144, '/reports/stock_sheet'),
  ...
  (201, 'Employee Standing Report', 'TREE.EMPLOYEE_STANDING_REPORT', 'Employee Standing Report', 144, '/reports/employeeStanding'),
  (202, 'Patient Standing Report', 'TREE.PATIENT_STANDING_REPORT', 'Patient Standing Report', 144, '/reports/patientStanding'),
  ...
  (206, '[OHADA] Bilan','TREE.OHADA_BALANCE_SHEET','',144,'/reports/ohada_balance_sheet_report'),
  (207, 'Account Reference Report','TREE.ACCOUNT_REFERENCE_REPORT','',144,'/reports/account_reference'),
  ...
  (238, 'Indicators report', 'TREE.INDICATORS_REPORT', 'Rapport sur les indicateurs', 144, '/reports/indicatorsReport'),
  (239, 'Visits Report', 'TREE.VISITS_REPORT', 'Visits registry', 144, '/reports/visit_report'),
  (240, '[Stock] Stock Entry Report','TREE.STOCK_ENTRY_REPORT','Stock Entry Report', 144,'/reports/stock_entry'),
