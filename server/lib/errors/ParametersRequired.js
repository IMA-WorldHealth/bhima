 ...
 * const ParametersRequired = require('lib/errors/ParametersRequired');
 *
 * // use the error in either a promise chain or directly via next()
 * return next(new ParametersRequired('Some description...'));
 *
 * @constructor
 */
function ParametersRequired(description) {
  'use strict';
  ...
  this.code = 'ERRORS.PARAMETERS_REQUIRED';
...
util.inherits(ParametersRequired, Error);

// expose the function to an external controller
module.exports = ParametersRequired;
