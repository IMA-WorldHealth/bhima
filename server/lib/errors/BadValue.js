 ...
 * const BadValue = require('lib/errors/BadValue');
 *
 * // use the error in either a promise chain or directly via next()
 * return next(new BadValue('Some description...'));
 *
 * @constructor
 */
function BadValue(description) {
  'use strict';
