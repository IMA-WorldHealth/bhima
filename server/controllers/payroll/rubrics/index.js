...
function lookupRubric(id) {
  const sql = `
    ...
    r.is_associated_employee, r.is_seniority_bonus, r.is_family_allowances
...
function list(req, res, next) {
  ...
  const sql = `
    SELECT r.id, UPPER(r.label) AS label, r.abbr, r.is_employee, r.is_percent, r.is_defined_employee, r.is_discount, r.is_social_care,
