...
const IS_EXIT = 0;
const ENTRY_FROM_ASSET_INTEGRATION_ID = 17;

/**
 * @function fetch
 * @description fetch stock entry from Asset integration
 */
function fetch(depotUuid, dateFrom, dateTo, showDetails) {
  ...
  WHERE m.is_exit = ${IS_EXIT} AND m.flux_id = ${ENTRY_FROM_ASSET_INTEGRATION_ID} AND d.uuid = ?
