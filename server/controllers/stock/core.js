 ...
 */
async function getOpeningStockBalance(date, depotUuid, inventoryUuid) {
...
async function getInventoryMovements(params) {
  ...
  if (params.dateFrom) {
    openingBalance = await getOpeningStockBalance(params.dateFrom, params.depot_uuid, params.inventory_uuid);
  }
