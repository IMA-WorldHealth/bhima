...
function configurationAnalysisTools(id) {
  const sql = `
    SELECT id, label, is_creditor, restrict_title_account, account_reference_id, analysis_tool_type_id
...
function list(req, res, next) {
  const sql = `
    SELECT at.id, at.label, at.is_creditor, at.restrict_title_account, at.account_reference_id,
