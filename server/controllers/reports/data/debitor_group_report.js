...
exports.compile = function (options) {
  ...
  var i18nDebtorGroupReport = options.language == 'fr' ? require('../lang/fr.json').DEBTOR_GROUP_REPORT : require('../lang/en.json').DEBTOR_GROUP_REPORT;
  ...
  context.dataStructure = i18nDebtorGroupReport;
